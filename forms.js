...
console.log(requForm.elements); // getting Collection of elements
...
const allRadios = requForm.elements.radio; // getting Collection of radio buttons
...
<select class="form__select" name="cities">
  <option class="form__option" value="" selected hidden>choose a city</option>
  <option class="form__option" value="kharkiv">Kharkiv</option>
  <option class="form__option" value="odesa">Odesa</option>
  <option class="form__option" value="lviv">Lviv</option>
  <option class="form__option" value="donetsk">Donetsk</option>      
</select>
...
console.log(formSelect.options); // shows Collection of options
...
const selectedCities = Array.from(formSelect.options)
...
// events focus and blur for all the form

requForm.addEventListener("focus", function () {
...
function getUserData(e) {
  ...
  const userName = userData.get("userName"); // gets input's value by its name attribute. Shows an array
  ...
  console.log(
    `My name is ${userDataObject.userName}. I am from ${userDataObject.cities}. I am ${userDataObject.userAge} old. I prefer to drink ${userDataObject.drinks}`
  );
}

// example with getting value from radio and checkbox

document.forms.training.querySelector('button').addEventListener('click', (e) => {
  e.preventDefault()
  
 const formData = new FormData(document.forms.training);
 
 const selectedRadio = formData.get('radio'); // show attribute value of the selected radio button
 console.log(selectedRadio);
 

 const selectedCheck = formData.has('check2');
 console.log(selectedCheck); // show true or false
